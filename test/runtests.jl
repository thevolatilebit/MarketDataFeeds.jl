...
# POLYGON
@assert haskey(ENV, "POLYGON_API_KEY") "please provide Polygon.io API key in POLYGON_API_KEY env var"
...
@assert body["iserver"]["authStatus"]["authenticated"] "IBKR session not authenticated"
